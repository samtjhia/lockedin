-- Revert get_leaderboard_for_date and get_leaderboard_for_week to pre-055 behavior (attribute by start date only).
-- Restores medal page "past 6 weeks" data. Session time split by day (055) remains only in the heatmap.
